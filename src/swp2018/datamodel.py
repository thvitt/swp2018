...
class DataModel:
    ...
    # Insert Data
    def insert_page_data(self, filename, height, width, text, coordinates, bounding_box, text_reg_id="no_info",
        ...
        self.pages_df = self.pages_df.append({"filename": filename, "height": height, "width": width,
                                              ...
                                              "bounding_box": bounding_box, "creator": creator, "created": created,
                                              "lastChange": last_change}, ignore_index=True)
        
    def insert_textlines_data(self, id_, textline, coordinates, bounding_box, pageNum):
        
        self.textlines_df = self.textlines_df.append({"id": id_, "textline": textline, "coordinates": coordinates,
                                                      "bounding_box": bounding_box, "pageNum": pageNum},
                                                     ignore_index=True)
